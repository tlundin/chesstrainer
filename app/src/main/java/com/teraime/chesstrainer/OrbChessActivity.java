 ...
 */
public class OrbChessActivity extends AppCompatActivity implements SceneManager, DoneCallback {
    ...
    public void start() {
        //if new player, call made after init. Otherwise, call after animation.
        if (initDone.get() && sceneDone.get()) {
            sceneDone.set(false);
